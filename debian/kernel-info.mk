...
KERNEL_BOOTIMAGE_CMDLINE = bootopt=64S3,32N2,64N2 droidian.lvm.prefer buildvariant=user
...
# Defconfig to use
KERNEL_DEFCONFIG = fire_defconfig
...
KERNEL_BOOTIMAGE_BASE_OFFSET = 0x4007800
